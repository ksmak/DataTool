    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_enable', models.BooleanField(default=True, verbose_name='доступен')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='find_fields', to='metadata.form', verbose_name='поисковая форма')),
            ],
            options={
