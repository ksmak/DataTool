    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num', models.PositiveSmallIntegerField(default=0, verbose_name='порядковый номер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='fields', to='metadata.group', verbose_name='группа')),
            ],
            options={
                'verbose_name': ('поле',),
