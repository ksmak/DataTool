    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='forms', to='main.database', verbose_name='база данных')),
            ],
            options={
                'verbose_name': ('форма',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='reports', to='main.database', verbose_name='база данных')),
            ],
            options={
                'verbose_name': ('отчет',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table_name', models.CharField(max_length=50, verbose_name='имя таблицы')),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='groups', to='main.form', verbose_name='форма')),
            ],
            options={
                'verbose_name': ('группа',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(choices=[('text', 'Простой текст без ограничений'), ('number', 'Целое число'), ('cyrillic', 'Только кириллица'), ('dict', 'Справочное значение')], max_length=15, verbose_name='тип поля')),
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='fields', to='main.group', verbose_name='группа')),
            ],
            options={
                'verbose_name': ('поле',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200, verbose_name='наименование')),
                ('data', models.JSONField(blank=True, null=True, verbose_name='json')),
                ('db', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='converters', to='main.database', verbose_name='база данных')),
                ('form', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='main.form', verbose_name='форма')),
            ],
            options={
